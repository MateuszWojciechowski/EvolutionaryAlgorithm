...
//            bufferedWriter.write(Main.network.getLinksNumber());
            ...
            Link[] links = Main.network.getLinks();
            for(int i=0; i < links.length; i++) {
                bufferedWriter.write(String.valueOf(links[i].getLinkID()) + " " + String.valueOf(links[i].getLinkLoad(Main.bruteForceSolution)) + " " + String.valueOf(links[i].getCapacity()));
                bufferedWriter.newLine();
            }
            bufferedWriter.newLine();
            //number of demands
            ...
            for(int i=0; i < demands.length; i++) {
                ...
                bufferedWriter.newLine();
                for(int j=0; j < paths.length; j++) {
                    SolutionDemand[] solutionDemands = Main.bruteForceSolution.getSolutionDemands();
                    bufferedWriter.write(String.valueOf(paths[j].getID()) + " " + solutionDemands[i].getAllocation()[j]);
                    bufferedWriter.newLine();
                }
                bufferedWriter.newLine();
            }
